            ...
            if(infoSeq[j].valid_data)
            {
                ...
                for(int i=0; i < msgList[j].messages.length(); i++)
                {
                    ...
                    mongo::StatusWith<mongo::Date_t> now  =
                            ...
                            (mongo::timeToISOString((time_t)msgList[j].timestamp));
                ...
                {
                case 11:
                    //DDS::Long lost11 = lostSample.total_count;
                    //cout << "11. dugum lost sample: " << lost11 << endl;
